...
class ModernTestsV2 : ModernBaseTest() {
    ...
    @Test(priority = 0, groups = ["modern"], enabled = false)
    ...
    @Test(priority = 1, groups = ["modern"], enabled = false)
    ...
    @Test(priority = 2, groups = ["modern"], enabled = false)
